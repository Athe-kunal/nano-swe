...
from nano_swe.models.utils import resolve_ac_mode
from nano_swe.trainer.fsdp.checkpoint import CheckpointManager
from nano_swe.trainer.fsdp.optimizer_offload import CpuOptimizerOffloader, local_shard
...
def _get_actor_cls():
    """Lazy import to avoid circular dep: nano_swe.models.actor imports from this package."""
    from nano_swe.models import Actor
...
class FsdpStrategy:
    ...
    def setup_distributed(self, timeout: timedelta = timedelta(minutes=30)) -> None:
        ...
        from nano_swe.utils.utils import convert_to_torch_dtype
    ...
    def _init_train_model(self, model, cfg: dict):
        ...
        if kind == "muon":
            ...
            from nano_swe.trainer.fsdp.muon import build_automodel_muon_optimizer
