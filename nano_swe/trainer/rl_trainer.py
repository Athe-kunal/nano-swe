...
from nano_swe.agents.base import _first_scalar
from nano_swe.datasets import PromptDataset
from nano_swe.datasets.utils import blending_datasets
from nano_swe.trainer.algorithm.experience import balance_experiences
from nano_swe.trainer.algorithm.kl_controller import AdaptiveKLController, FixedKLController
from nano_swe.trainer.fsdp import FsdpStrategy
from nano_swe.trainer.rollout.experience_maker import RemoteExperienceMaker
from nano_swe.trainer.rollout.samples_generator import SamplesGenerator
from nano_swe.trainer.vllm.vllm_engine import batch_vllm_engine_call
from nano_swe.trainer.workers.actor_group import RayActorGroup
from nano_swe.utils.distributed_sampler import DistributedSampler
from nano_swe.utils.logging_utils import TensorboardLogger, WandbLogger, init_logger
from nano_swe.utils.utils import get_tokenizer
...
class GenerateSamplesActor:
    def __init__(
        ...
        **generate_kwargs,
        ...
        from nano_swe.trainer.rollout.router import AgentRunnerActor
